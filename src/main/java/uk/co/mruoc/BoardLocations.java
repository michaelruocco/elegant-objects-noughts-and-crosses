...
@EqualsAndHashCode
public class BoardLocations implements BoardState {

    private final BoardSize size;
    private final Map<Coordinates, Token> locations;

    public BoardLocations(BoardSize size) {
    ...
    public BoardLocations place(Coordinates coordinates, Token newToken) {
        var newLocations = new LinkedHashMap<>(locations);
        newLocations.put(coordinates, newToken);
        return new BoardLocations(size, newLocations);
    }
    ...
    public BoardLocations initialized() {
        ...
        return new BoardLocations(size, Collections.unmodifiableMap(freeLocations));
    }
}
